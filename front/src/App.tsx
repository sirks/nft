...
const App = () => {
    ...
    if (!window.ethereum) {
        ...
        //     // window.location.replace("https://metamask.app.link/dapp/techchill-85703.web.app");
        //
        ...
        //     // a.target = "_self";
        //     // a.click();
        //     // alert("https://metamask.app.link/dapp/" + window.location.host);
        //     return (
        //         <div className="bg-white text-black text-4xl container">
        //             <Welcome provider={null} lastMintUrl={''}/>
        //             <InstallMetamask url={"https://metamask.app.link/dapp/" + window.location.host}/>
        //         </div>
        //     );
        // }
